...
class SignUpForm(UserCreationForm):
    email = forms.EmailField(label="",
                             widget=forms.EmailInput(attrs={'class': 'from-control', 'placeholder': 'Email Address'})),
    first_name = forms.CharField(label="", max_length=100,
                                 widget=forms.TextInput(attrs={'class': 'from-control', 'placeholder': 'First Name'})),
    last_name = forms.CharField(label="", max_length=100,
                                widget=forms.TextInput(attrs={'class': 'from-control', 'placeholder': 'Last Name'})),
...
class AddRecord(forms.ModelForm):
    ...
    phone = forms.CharField(required=True, max_length=60,
                            ...
                            label="")
    email = forms.CharField(required=True, max_length=80,
                            widget=forms.widgets.TextInput(attrs={'placeholder': 'Email', 'class': 'form-control'}),
                            label="")
    city = forms.CharField(required=True, max_length=60,
                           widget=forms.widgets.TextInput(attrs={'placeholder': 'City', 'class': 'form-control'}),
                           label="")
    state = forms.CharField(required=True, max_length=60,
    ...
    address = forms.CharField(required=True, max_length=60,
                              ...
                              label="")
    zipcode = forms.CharField(required=True, max_length=60,
